...
//                        @Override
//                        protected boolean action(InterpreterState state, String[] arguments) {
//                            StoreableTable currentTable = getCurrentTableWithoutMessages(state);
//                            int changesCount = 0;
//                            if (currentTable != null) {
//                                changesCount = currentTable.changesCount();
//                            }
...
//    }
//
//    private static StoreableTable getCurrentTableWithoutMessages(InterpreterState state) {
//        return (StoreableTable) ((DatabaseState) state).getDatabase().getCurrentTable();
//    }
//
//    private static StoreableTable getCurrentTable(InterpreterState state) throws TableNotFoundException {
//        return ((StoreableTable) MultiFileHashMap.getCurrentTable(state));
//    }
//
