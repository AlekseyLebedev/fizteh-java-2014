...
public class StringTableTest {
    ...
    public void setUp() throws Exception {
        ru.fizteh.fivt.storage.structured.Table tableInstance = database.getTable(TEST_TABLE_NAME);
    ...
    protected void createTable() throws IOException {
        table = StringTableWrapper.create(database.createTable(TEST_TABLE_NAME, Arrays.asList(String.class)),
                (Database) database);
    }
    ...
    public void testGetName() throws Exception {
        ...
        Assert.assertEquals("Qwerty",
                database.createTable("Qwerty", Arrays.asList(Integer.class, Boolean.class)).getName());
    ...
    private void checkCommit(int value, int position) throws IOException {
    ...
    private int checkCommit() throws IOException {
        ...
        for (File dir : directories) {
            if (dir.isDirectory()) {
                ...
                Assert.assertEquals("signature.tsv", dir.getName());
            }
        }
        return changes;
    }
    ...
    @Test
    public void testCommitWithCollisions() throws IOException {
        table.put("Q1", "text");
        table.put("r2", "text");
